...
pred_contrast_tab_mv <- bind_rows(pred_vfd_mv, pred_icu_mv, pred_hosp_mv, pred_30_mv, pred_365_mv)

wb_mv <- createWorkbook()
addWorksheet(wb_mv, "VFD")
writeData(wb_mv, "VFD", tab_vfd_mv)
addWorksheet(wb_mv, "ICU_LOS")
writeData(wb_mv, "ICU_LOS", tab_icu_los_mv)
addWorksheet(wb_mv, "Hosp")
writeData(wb_mv, "Hosp", tab_dead_hosp_mv)
addWorksheet(wb_mv, "30Day")
writeData(wb_mv, "30Day", tab_dead_30_mv)
addWorksheet(wb_mv, "1Year")
writeData(wb_mv, "1Year", tab_dead_365_mv)
addWorksheet(wb_mv, "Predicted_Contrast")
writeData(wb_mv, "Predicted_Contrast", pred_contrast_tab_mv)
saveWorkbook(wb_mv, file = file.path(output_folder, "final", "ccw_IPCW_results_multivariate.xlsx"), overwrite = TRUE)